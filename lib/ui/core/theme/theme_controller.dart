...
class AppThemeController extends ChangeNotifier {
  ...
  Future<void> loadPersistedTheme() async {
    ...
    _selectedDarkPresetIndex  = (prefs.getInt(_kDarkPreset)  ?? 0).clamp(0, darkPresets.length - 1);
    _selectedLightPresetIndex = (prefs.getInt(_kLightPreset) ?? 0).clamp(0, lightPresets.length - 1);
  ...
  void _persist() {
    SharedPreferences.getInstance().then((prefs) {
      ...
      if (_customDarkAccentColor  != null) prefs.setInt(_kDarkAccent,  _customDarkAccentColor!.toARGB32());
      if (_customLightAccentColor != null) prefs.setInt(_kLightAccent, _customLightAccentColor!.toARGB32());
